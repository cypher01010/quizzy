			...
			<?php } else { ?>
				<div class="panel-body">
					<?php $form = ActiveForm::begin([
						...
						<div class="form-group">
							<?php echo $form->field($registerForm, 'academicLevel')->dropDownList($academicLevelList); ?>
							<?php echo $form->field($registerForm, 'schoolType')->dropDownList($schoolList); ?>
							<?php echo $form->field($registerForm, 'schoolName'); ?>
						</div>
...
$('#registerform-birthday').combodate();
</script>
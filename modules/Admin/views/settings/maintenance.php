			...
			<div class="panel-body" style="padding-top: 0px;">
				<form role="form" method="post" name="page-content-form" id="page-content-form">
					<div class="form-group">
						...
						<select class="form-control" id="under-maintenance" name="under-maintenance">
							<?php foreach ($maintenanceSelect as $key => $value) { ?>
								<?php if($maintenance == 1 && $key == 1) { ?>
									<option value="<?php echo $key; ?>" selected><?php echo $value; ?></option>
								<?php } else if($maintenance == 0 && $key == 0) { ?>
									<option value="<?php echo $key; ?>" selected><?php echo $value; ?></option>
								<?php } else { ?>
					...
					<div class="form-group">
						<div class="alert alert-default">
							<p>NOTE: When set the Website under MAINTENANCE mode, you may use this login page <strong><?php echo Yii::$app->urlManager->createAbsoluteUrl(['admin/user/login']); ?></strong></p>

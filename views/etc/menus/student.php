<!-- account links -->
<ul class="nav nav-userinfo navbar-right navbar-nav login-user-nav-header">
	<li class="dropdown user-profile">
		...
		<ul class="dropdown-menu user-profile-menu list-unstyled">
			...
			<li>
				<a href="<?php echo \Yii::$app->getUrlManager()->createUrl(['classes/default/user', 'username' => \Yii::$app->session->get('username')]); ?>">
					<i class="fa-group"></i>
					Class
				</a>
			</li>
